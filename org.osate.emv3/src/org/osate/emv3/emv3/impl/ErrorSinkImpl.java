 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorSinkImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorSinkImpl#isAllIncoming <em>All Incoming</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ErrorSinkImpl extends ErrorFlowImpl implements ErrorSink {
	...
	protected EClass eStaticClass() {
		return Emv3Package.Literals.ERROR_SINK;
	}
		...
		if (incoming != null && incoming.eIsProxy()) {
			...
			if (incoming != oldIncoming) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Emv3Package.ERROR_SINK__INCOMING, oldIncoming, incoming));
			}
		}
		return incoming;
	}
	...
	public void setIncoming(ErrorPropagation newIncoming) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_SINK__INCOMING, oldIncoming, incoming));
	}
	...
	public void setAllIncoming(boolean newAllIncoming) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_SINK__ALL_INCOMING, oldAllIncoming, allIncoming));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Emv3Package.ERROR_SINK__INCOMING:
				if (resolve) return getIncoming();
				return basicGetIncoming();
			case Emv3Package.ERROR_SINK__ALL_INCOMING:
