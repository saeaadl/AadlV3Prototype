 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.emv3.emv3.impl.OutgoingPropagationConditionImpl#getState <em>State</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.OutgoingPropagationConditionImpl#getTypeTokenConstraint <em>Type Token Constraint</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.OutgoingPropagationConditionImpl#isAllStates <em>All States</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.OutgoingPropagationConditionImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.OutgoingPropagationConditionImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.OutgoingPropagationConditionImpl#isAllPropagations <em>All Propagations</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.OutgoingPropagationConditionImpl#getTypeToken <em>Type Token</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutgoingPropagationConditionImpl extends NamedElementImpl implements OutgoingPropagationCondition {
	...
	protected EClass eStaticClass() {
		return Emv3Package.Literals.OUTGOING_PROPAGATION_CONDITION;
	}
		...
		if (state != null && state.eIsProxy()) {
			...
			if (state != oldState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Emv3Package.OUTGOING_PROPAGATION_CONDITION__STATE, oldState, state));
			}
		}
		return state;
	}
	...
	public void setState(ErrorBehaviorState newState) {
		...
		state = newState;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.OUTGOING_PROPAGATION_CONDITION__STATE, oldState, state));
	}
	...
	public NotificationChain basicSetTypeTokenConstraint(TypeSet newTypeTokenConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Emv3Package.OUTGOING_PROPAGATION_CONDITION__TYPE_TOKEN_CONSTRAINT, oldTypeTokenConstraint, newTypeTokenConstraint);
	...
	public void setTypeTokenConstraint(TypeSet newTypeTokenConstraint) {
		if (newTypeTokenConstraint != typeTokenConstraint) {
			...
			if (typeTokenConstraint != null)
				msgs = ((InternalEObject)typeTokenConstraint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Emv3Package.OUTGOING_PROPAGATION_CONDITION__TYPE_TOKEN_CONSTRAINT, null, msgs);
			if (newTypeTokenConstraint != null)
				msgs = ((InternalEObject)newTypeTokenConstraint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Emv3Package.OUTGOING_PROPAGATION_CONDITION__TYPE_TOKEN_CONSTRAINT, null, msgs);
			msgs = basicSetTypeTokenConstraint(newTypeTokenConstraint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.OUTGOING_PROPAGATION_CONDITION__TYPE_TOKEN_CONSTRAINT, newTypeTokenConstraint, newTypeTokenConstraint));
	}
	...
	public void setAllStates(boolean newAllStates) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.OUTGOING_PROPAGATION_CONDITION__ALL_STATES, oldAllStates, allStates));
	}
	...
	public NotificationChain basicSetCondition(ConditionExpression newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Emv3Package.OUTGOING_PROPAGATION_CONDITION__CONDITION, oldCondition, newCondition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCondition(ConditionExpression newCondition) {
		if (newCondition != condition) {
			NotificationChain msgs = null;
			if (condition != null)
				msgs = ((InternalEObject)condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Emv3Package.OUTGOING_PROPAGATION_CONDITION__CONDITION, null, msgs);
			if (newCondition != null)
				msgs = ((InternalEObject)newCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Emv3Package.OUTGOING_PROPAGATION_CONDITION__CONDITION, null, msgs);
			msgs = basicSetCondition(newCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.OUTGOING_PROPAGATION_CONDITION__CONDITION, newCondition, newCondition));
	}
	...
	public ErrorPropagation getOutgoing() {
		if (outgoing != null && outgoing.eIsProxy()) {
			...
			if (outgoing != oldOutgoing) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Emv3Package.OUTGOING_PROPAGATION_CONDITION__OUTGOING, oldOutgoing, outgoing));
			}
		}
		return outgoing;
	}
	...
	public void setOutgoing(ErrorPropagation newOutgoing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.OUTGOING_PROPAGATION_CONDITION__OUTGOING, oldOutgoing, outgoing));
	}
	...
	public void setAllPropagations(boolean newAllPropagations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.OUTGOING_PROPAGATION_CONDITION__ALL_PROPAGATIONS, oldAllPropagations, allPropagations));
	}
	...
	public NotificationChain basicSetTypeToken(TypeSet newTypeToken, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Emv3Package.OUTGOING_PROPAGATION_CONDITION__TYPE_TOKEN, oldTypeToken, newTypeToken);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTypeToken(TypeSet newTypeToken) {
		if (newTypeToken != typeToken) {
			NotificationChain msgs = null;
			if (typeToken != null)
				msgs = ((InternalEObject)typeToken).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Emv3Package.OUTGOING_PROPAGATION_CONDITION__TYPE_TOKEN, null, msgs);
			if (newTypeToken != null)
				msgs = ((InternalEObject)newTypeToken).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Emv3Package.OUTGOING_PROPAGATION_CONDITION__TYPE_TOKEN, null, msgs);
			msgs = basicSetTypeToken(newTypeToken, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.OUTGOING_PROPAGATION_CONDITION__TYPE_TOKEN, newTypeToken, newTypeToken));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Emv3Package.OUTGOING_PROPAGATION_CONDITION__STATE:
			...
			case Emv3Package.OUTGOING_PROPAGATION_CONDITION__CONDITION:
				return getCondition();
			case Emv3Package.OUTGOING_PROPAGATION_CONDITION__OUTGOING:
