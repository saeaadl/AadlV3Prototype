 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.emv3.emv3.impl.OrExpressionImpl#getOperands <em>Operands</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrExpressionImpl extends ConditionExpressionImpl implements OrExpression {
	...
	protected EClass eStaticClass() {
		return Emv3Package.Literals.OR_EXPRESSION;
	}
	...
	public EList<ConditionExpression> getOperands() {
		if (operands == null) {
			operands = new EObjectContainmentEList<ConditionExpression>(ConditionExpression.class, this, Emv3Package.OR_EXPRESSION__OPERANDS);
		}
		return operands;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Emv3Package.OR_EXPRESSION__OPERANDS:
