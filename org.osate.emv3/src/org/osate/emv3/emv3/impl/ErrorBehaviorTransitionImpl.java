 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorBehaviorTransitionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorBehaviorTransitionImpl#getTypeTokenConstraint <em>Type Token Constraint</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorBehaviorTransitionImpl#isAllStates <em>All States</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorBehaviorTransitionImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorBehaviorTransitionImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorBehaviorTransitionImpl#getTargetToken <em>Target Token</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorBehaviorTransitionImpl#isSteadyState <em>Steady State</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorBehaviorTransitionImpl#getDestinationBranches <em>Destination Branches</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ErrorBehaviorTransitionImpl extends NamedElementImpl implements ErrorBehaviorTransition {
	...
	protected EClass eStaticClass() {
		return Emv3Package.Literals.ERROR_BEHAVIOR_TRANSITION;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Emv3Package.ERROR_BEHAVIOR_TRANSITION__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(ErrorBehaviorState newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_BEHAVIOR_TRANSITION__SOURCE, oldSource, source));
	}
	...
	public NotificationChain basicSetTypeTokenConstraint(TypeSet newTypeTokenConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_BEHAVIOR_TRANSITION__TYPE_TOKEN_CONSTRAINT, oldTypeTokenConstraint, newTypeTokenConstraint);
	...
	public void setTypeTokenConstraint(TypeSet newTypeTokenConstraint) {
		if (newTypeTokenConstraint != typeTokenConstraint) {
			...
			if (typeTokenConstraint != null)
				msgs = ((InternalEObject)typeTokenConstraint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Emv3Package.ERROR_BEHAVIOR_TRANSITION__TYPE_TOKEN_CONSTRAINT, null, msgs);
			if (newTypeTokenConstraint != null)
				msgs = ((InternalEObject)newTypeTokenConstraint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Emv3Package.ERROR_BEHAVIOR_TRANSITION__TYPE_TOKEN_CONSTRAINT, null, msgs);
			msgs = basicSetTypeTokenConstraint(newTypeTokenConstraint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_BEHAVIOR_TRANSITION__TYPE_TOKEN_CONSTRAINT, newTypeTokenConstraint, newTypeTokenConstraint));
	}
	...
	public void setAllStates(boolean newAllStates) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_BEHAVIOR_TRANSITION__ALL_STATES, oldAllStates, allStates));
	}
	...
	public NotificationChain basicSetCondition(ConditionExpression newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_BEHAVIOR_TRANSITION__CONDITION, oldCondition, newCondition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCondition(ConditionExpression newCondition) {
		if (newCondition != condition) {
			NotificationChain msgs = null;
			if (condition != null)
				msgs = ((InternalEObject)condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Emv3Package.ERROR_BEHAVIOR_TRANSITION__CONDITION, null, msgs);
			if (newCondition != null)
				msgs = ((InternalEObject)newCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Emv3Package.ERROR_BEHAVIOR_TRANSITION__CONDITION, null, msgs);
			msgs = basicSetCondition(newCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_BEHAVIOR_TRANSITION__CONDITION, newCondition, newCondition));
	}
	...
	public ErrorBehaviorState getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Emv3Package.ERROR_BEHAVIOR_TRANSITION__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(ErrorBehaviorState newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_BEHAVIOR_TRANSITION__TARGET, oldTarget, target));
	}
	...
	public NotificationChain basicSetTargetToken(TypeSet newTargetToken, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_BEHAVIOR_TRANSITION__TARGET_TOKEN, oldTargetToken, newTargetToken);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTargetToken(TypeSet newTargetToken) {
		if (newTargetToken != targetToken) {
			NotificationChain msgs = null;
			if (targetToken != null)
				msgs = ((InternalEObject)targetToken).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Emv3Package.ERROR_BEHAVIOR_TRANSITION__TARGET_TOKEN, null, msgs);
			if (newTargetToken != null)
				msgs = ((InternalEObject)newTargetToken).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Emv3Package.ERROR_BEHAVIOR_TRANSITION__TARGET_TOKEN, null, msgs);
			msgs = basicSetTargetToken(newTargetToken, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_BEHAVIOR_TRANSITION__TARGET_TOKEN, newTargetToken, newTargetToken));
	}
	...
	public void setSteadyState(boolean newSteadyState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_BEHAVIOR_TRANSITION__STEADY_STATE, oldSteadyState, steadyState));
	}
	...
	public EList<TransitionBranch> getDestinationBranches() {
		if (destinationBranches == null) {
			destinationBranches = new EObjectContainmentEList<TransitionBranch>(TransitionBranch.class, this, Emv3Package.ERROR_BEHAVIOR_TRANSITION__DESTINATION_BRANCHES);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Emv3Package.ERROR_BEHAVIOR_TRANSITION__SOURCE:
			...
			case Emv3Package.ERROR_BEHAVIOR_TRANSITION__CONDITION:
				return getCondition();
			case Emv3Package.ERROR_BEHAVIOR_TRANSITION__TARGET:
