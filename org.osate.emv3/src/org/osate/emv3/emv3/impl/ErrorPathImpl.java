 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorPathImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorPathImpl#isAllIncoming <em>All Incoming</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorPathImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorPathImpl#isAllOutgoing <em>All Outgoing</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorPathImpl#getTargetToken <em>Target Token</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorPathImpl#getTypeMappingSet <em>Type Mapping Set</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ErrorPathImpl extends ErrorFlowImpl implements ErrorPath {
	...
	protected EClass eStaticClass() {
		return Emv3Package.Literals.ERROR_PATH;
	}
		...
		if (incoming != null && incoming.eIsProxy()) {
			...
			if (incoming != oldIncoming) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Emv3Package.ERROR_PATH__INCOMING, oldIncoming, incoming));
			}
		}
		return incoming;
	}
	...
	public void setIncoming(ErrorPropagation newIncoming) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_PATH__INCOMING, oldIncoming, incoming));
	}
	...
	public void setAllIncoming(boolean newAllIncoming) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_PATH__ALL_INCOMING, oldAllIncoming, allIncoming));
	}
	...
	public ErrorPropagation getOutgoing() {
		if (outgoing != null && outgoing.eIsProxy()) {
			...
			if (outgoing != oldOutgoing) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Emv3Package.ERROR_PATH__OUTGOING, oldOutgoing, outgoing));
			}
		}
		return outgoing;
	}
	...
	public void setOutgoing(ErrorPropagation newOutgoing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_PATH__OUTGOING, oldOutgoing, outgoing));
	}
	...
	public void setAllOutgoing(boolean newAllOutgoing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_PATH__ALL_OUTGOING, oldAllOutgoing, allOutgoing));
	}
	...
	public NotificationChain basicSetTargetToken(TypeSet newTargetToken, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_PATH__TARGET_TOKEN, oldTargetToken, newTargetToken);
	...
	public void setTargetToken(TypeSet newTargetToken) {
		if (newTargetToken != targetToken) {
			...
			if (targetToken != null)
				msgs = ((InternalEObject)targetToken).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Emv3Package.ERROR_PATH__TARGET_TOKEN, null, msgs);
			if (newTargetToken != null)
				msgs = ((InternalEObject)newTargetToken).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Emv3Package.ERROR_PATH__TARGET_TOKEN, null, msgs);
			msgs = basicSetTargetToken(newTargetToken, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_PATH__TARGET_TOKEN, newTargetToken, newTargetToken));
	}
	...
	public TypeMappingSet getTypeMappingSet() {
		if (typeMappingSet != null && typeMappingSet.eIsProxy()) {
			...
			if (typeMappingSet != oldTypeMappingSet) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Emv3Package.ERROR_PATH__TYPE_MAPPING_SET, oldTypeMappingSet, typeMappingSet));
			}
		}
	...
	public void setTypeMappingSet(TypeMappingSet newTypeMappingSet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_PATH__TYPE_MAPPING_SET, oldTypeMappingSet, typeMappingSet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Emv3Package.ERROR_PATH__TARGET_TOKEN:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Emv3Package.ERROR_PATH__INCOMING:
				if (resolve) return getIncoming();
				return basicGetIncoming();
			case Emv3Package.ERROR_PATH__ALL_INCOMING:
				return isAllIncoming();
			case Emv3Package.ERROR_PATH__OUTGOING:
				if (resolve) return getOutgoing();
				return basicGetOutgoing();
			case Emv3Package.ERROR_PATH__ALL_OUTGOING:
				return isAllOutgoing();
			case Emv3Package.ERROR_PATH__TARGET_TOKEN:
				return getTargetToken();
			case Emv3Package.ERROR_PATH__TYPE_MAPPING_SET:
