 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorTypeImpl#getSuperType <em>Super Type</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorTypeImpl#getAliasedType <em>Aliased Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ErrorTypeImpl extends ErrorTypesImpl implements ErrorType {
		...
		if (superType != null && superType.eIsProxy()) {
			...
			if (superType != oldSuperType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Emv3Package.ERROR_TYPE__SUPER_TYPE, oldSuperType, superType));
			}
		}
		return superType;
	}
	...
	public void setSuperType(ErrorType newSuperType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_TYPE__SUPER_TYPE, oldSuperType, superType));
	}
	...
	public ErrorType getAliasedType() {
		if (aliasedType != null && aliasedType.eIsProxy()) {
			...
			if (aliasedType != oldAliasedType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Emv3Package.ERROR_TYPE__ALIASED_TYPE, oldAliasedType, aliasedType));
			}
		}
		return aliasedType;
	}
	...
	public void setAliasedType(ErrorType newAliasedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_TYPE__ALIASED_TYPE, oldAliasedType, aliasedType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Emv3Package.ERROR_TYPE__SUPER_TYPE:
				if (resolve) return getSuperType();
				return basicGetSuperType();
			case Emv3Package.ERROR_TYPE__ALIASED_TYPE:
