 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.emv3.emv3.impl.TypeSetImpl#getTypeTokens <em>Type Tokens</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.TypeSetImpl#getAliasedType <em>Aliased Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeSetImpl extends ErrorTypesImpl implements TypeSet {
	...
	protected EClass eStaticClass() {
		return Emv3Package.Literals.TYPE_SET;
	}
	...
	public EList<TypeToken> getTypeTokens() {
		if (typeTokens == null) {
			typeTokens = new EObjectContainmentEList<TypeToken>(TypeToken.class, this, Emv3Package.TYPE_SET__TYPE_TOKENS);
		}
		return typeTokens;
	}
		...
		if (aliasedType != null && aliasedType.eIsProxy()) {
			...
			if (aliasedType != oldAliasedType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Emv3Package.TYPE_SET__ALIASED_TYPE, oldAliasedType, aliasedType));
			}
		}
		return aliasedType;
	}
	...
	public void setAliasedType(TypeSet newAliasedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.TYPE_SET__ALIASED_TYPE, oldAliasedType, aliasedType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Emv3Package.TYPE_SET__TYPE_TOKENS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Emv3Package.TYPE_SET__ALIASED_TYPE:
