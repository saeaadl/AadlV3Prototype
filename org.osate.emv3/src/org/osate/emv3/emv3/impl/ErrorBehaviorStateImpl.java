 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorBehaviorStateImpl#isIntial <em>Intial</em>}</li>
 *   <li>{@link org.osate.emv3.emv3.impl.ErrorBehaviorStateImpl#getTypeSet <em>Type Set</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ErrorBehaviorStateImpl extends NamedElementImpl implements ErrorBehaviorState {
	...
	protected EClass eStaticClass() {
		return Emv3Package.Literals.ERROR_BEHAVIOR_STATE;
	}
	...
	public void setIntial(boolean newIntial) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_BEHAVIOR_STATE__INTIAL, oldIntial, intial));
	}
	...
	public NotificationChain basicSetTypeSet(TypeSet newTypeSet, NotificationChain msgs) {
		...
		typeSet = newTypeSet;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_BEHAVIOR_STATE__TYPE_SET, oldTypeSet, newTypeSet);
	...
	public void setTypeSet(TypeSet newTypeSet) {
		if (newTypeSet != typeSet) {
			...
			if (typeSet != null)
				msgs = ((InternalEObject)typeSet).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Emv3Package.ERROR_BEHAVIOR_STATE__TYPE_SET, null, msgs);
			if (newTypeSet != null)
				msgs = ((InternalEObject)newTypeSet).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Emv3Package.ERROR_BEHAVIOR_STATE__TYPE_SET, null, msgs);
			msgs = basicSetTypeSet(newTypeSet, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Emv3Package.ERROR_BEHAVIOR_STATE__TYPE_SET, newTypeSet, newTypeSet));
	}
