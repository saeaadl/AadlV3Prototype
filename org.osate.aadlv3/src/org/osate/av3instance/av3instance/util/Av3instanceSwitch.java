...
public class Av3instanceSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Av3instancePackage.SINK_INSTANCE: {
			SinkInstance sinkInstance = (SinkInstance) theEObject;
			T result = caseSinkInstance(sinkInstance);
			if (result == null)
				result = caseInstanceObject(sinkInstance);
			if (result == null)
				result = caseNamedElement(sinkInstance);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sink Instance</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sink Instance</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSinkInstance(SinkInstance object) {
		return null;
	}
