 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.aadlv3.aadlv3.impl.ConfigurationParameterImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfigurationParameterImpl extends TypeImpl implements ConfigurationParameter {
	...
	protected EClass eStaticClass() {
		return Aadlv3Package.Literals.CONFIGURATION_PARAMETER;
	}
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Aadlv3Package.CONFIGURATION_PARAMETER__TYPE, oldType, type));
			}
		}
		return type;
	}
