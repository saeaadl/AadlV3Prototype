...
public class ComponentImpl extends ModelElementImpl implements Component {
	 ...
	 * @ordered
	 */
	protected static final ComponentCategory CATEGORY_EDEFAULT = ComponentCategory.COMPONENT;
	...
	protected EClass eStaticClass() {
		return Aadlv3Package.Literals.COMPONENT;
	}
	...
	public void setCategory(ComponentCategory newCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Aadlv3Package.COMPONENT__CATEGORY, oldCategory,
					category));
	}
	...
	public EList<Component> getComponents() {
		if (components == null) {
			components = new EObjectContainmentEList<Component>(Component.class, this,
					Aadlv3Package.COMPONENT__COMPONENTS);
		}
		return components;
	}
	...
	public EList<Association> getConnections() {
		if (connections == null) {
			connections = new EObjectContainmentEList<Association>(Association.class, this,
					Aadlv3Package.COMPONENT__CONNECTIONS);
		}
		return connections;
	}
	...
	public EList<Feature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentEList<Feature>(Feature.class, this, Aadlv3Package.COMPONENT__FEATURES);
		}
		return features;
	}
