...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>State Synchronization</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.osate.aadlv3.aadlv3.impl.StateSynchronizationImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.osate.aadlv3.aadlv3.impl.StateSynchronizationImpl#getTargetState <em>Target State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateSynchronizationImpl extends ModelElementImpl implements StateSynchronization {
	/**
	 ...
	 * @generated
	 */
	protected StateSynchronizationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Aadlv3Package.Literals.STATE_SYNCHRONIZATION;
	}
	...
	public NotificationChain basicSetCondition(Literal newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Aadlv3Package.STATE_SYNCHRONIZATION__CONDITION, oldCondition, newCondition);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject) condition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Aadlv3Package.STATE_SYNCHRONIZATION__CONDITION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Aadlv3Package.STATE_SYNCHRONIZATION__CONDITION,
	...
	public NotificationChain basicSetTargetState(BinaryOperation newTargetState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Aadlv3Package.STATE_SYNCHRONIZATION__TARGET_STATE, oldTargetState, newTargetState);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newTargetState != targetState) {
			...
			if (targetState != null)
				msgs = ((InternalEObject) targetState).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Aadlv3Package.STATE_SYNCHRONIZATION__TARGET_STATE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Aadlv3Package.STATE_SYNCHRONIZATION__TARGET_STATE,
