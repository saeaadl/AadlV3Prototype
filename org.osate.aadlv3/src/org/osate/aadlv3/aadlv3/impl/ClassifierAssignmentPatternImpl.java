...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Classifier Assignment Pattern</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.osate.aadlv3.aadlv3.impl.ClassifierAssignmentPatternImpl#getTargetPattern <em>Target Pattern</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClassifierAssignmentPatternImpl extends ClassifierAssignmentImpl implements ClassifierAssignmentPattern {
	/**
	 ...
	 * @generated
	 */
	protected ClassifierAssignmentPatternImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Aadlv3Package.Literals.CLASSIFIER_ASSIGNMENT_PATTERN;
	}
			...
			if (targetPattern != oldTargetPattern) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Aadlv3Package.CLASSIFIER_ASSIGNMENT_PATTERN__TARGET_PATTERN, oldTargetPattern,
							targetPattern));
			}
		}
	...
	public void setTargetPattern(Type newTargetPattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Aadlv3Package.CLASSIFIER_ASSIGNMENT_PATTERN__TARGET_PATTERN, oldTargetPattern, targetPattern));
	}
...
} //ClassifierAssignmentPatternImpl
