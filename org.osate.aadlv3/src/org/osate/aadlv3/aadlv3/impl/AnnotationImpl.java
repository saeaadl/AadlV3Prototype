...
public class AnnotationImpl extends MinimalEObjectImpl.Container implements Annotation {
	 ...
	 * @ordered
	 */
	protected EList<NameValuePair> parameters;
	...
	protected EClass eStaticClass() {
		return Aadlv3Package.Literals.ANNOTATION;
	}
	 ...
	 */
	@Override
	public EList<NameValuePair> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<NameValuePair>(NameValuePair.class, this,
					Aadlv3Package.ANNOTATION__PARAMETERS);
		}
		return parameters;
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Aadlv3Package.ANNOTATION__PARAMETERS:
			getParameters().clear();
			getParameters().addAll((Collection<? extends NameValuePair>) newValue);
			return;
		}
