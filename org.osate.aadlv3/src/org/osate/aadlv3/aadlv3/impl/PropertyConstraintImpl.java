 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.aadlv3.aadlv3.impl.PropertyConstraintImpl#getConstrainedProperty <em>Constrained Property</em>}</li>
 *   <li>{@link org.osate.aadlv3.aadlv3.impl.PropertyConstraintImpl#getConstraintExpression <em>Constraint Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyConstraintImpl extends MinimalEObjectImpl.Container implements PropertyConstraint {
	 ...
	 * @ordered
	 */
	protected MultiLiteralConstraint constraintExpression;
	...
	protected EClass eStaticClass() {
		return Aadlv3Package.Literals.PROPERTY_CONSTRAINT;
	}
			...
			if (constrainedProperty != oldConstrainedProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Aadlv3Package.PROPERTY_CONSTRAINT__CONSTRAINED_PROPERTY, oldConstrainedProperty,
							constrainedProperty));
			}
		}
	 ...
	 */
	@Override
	public MultiLiteralConstraint getConstraintExpression() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetConstraintExpression(MultiLiteralConstraint newConstraintExpression,
			NotificationChain msgs) {
		MultiLiteralConstraint oldConstraintExpression = constraintExpression;
		constraintExpression = newConstraintExpression;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Aadlv3Package.PROPERTY_CONSTRAINT__CONSTRAINT_EXPRESSION, oldConstraintExpression,
	 ...
	 */
	@Override
	public void setConstraintExpression(MultiLiteralConstraint newConstraintExpression) {
		if (newConstraintExpression != constraintExpression) {
			NotificationChain msgs = null;
			if (constraintExpression != null)
				msgs = ((InternalEObject) constraintExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Aadlv3Package.PROPERTY_CONSTRAINT__CONSTRAINT_EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Aadlv3Package.PROPERTY_CONSTRAINT__CONSTRAINT_EXPRESSION, newConstraintExpression,
					newConstraintExpression));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Aadlv3Package.PROPERTY_CONSTRAINT__CONSTRAINED_PROPERTY:
			if (resolve)
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Aadlv3Package.PROPERTY_CONSTRAINT__CONSTRAINED_PROPERTY:
			...
			return;
		case Aadlv3Package.PROPERTY_CONSTRAINT__CONSTRAINT_EXPRESSION:
			setConstraintExpression((MultiLiteralConstraint) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		...
		case Aadlv3Package.PROPERTY_CONSTRAINT__CONSTRAINED_PROPERTY:
			...
			return;
		case Aadlv3Package.PROPERTY_CONSTRAINT__CONSTRAINT_EXPRESSION:
			setConstraintExpression((MultiLiteralConstraint) null);
			return;
		}
