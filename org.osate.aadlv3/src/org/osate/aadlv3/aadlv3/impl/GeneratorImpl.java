 ...
 * @generated
 */
public class GeneratorImpl extends ModelElementImpl implements Generator {
	/**
	...
	protected EClass eStaticClass() {
		return Aadlv3Package.Literals.GENERATOR;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Aadlv3Package.GENERATOR__TYPE, oldType, type));
	}
