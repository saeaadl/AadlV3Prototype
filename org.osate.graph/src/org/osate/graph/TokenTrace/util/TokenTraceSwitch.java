 ...
 * @generated
 */
public class TokenTraceSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TokenTracePackage.TOKEN_TRACE: {
				TokenTrace tokenTrace = (TokenTrace)theEObject;
				T result = caseTokenTrace(tokenTrace);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Token Trace</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Token Trace</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTokenTrace(TokenTrace object) {
		return null;
	}
