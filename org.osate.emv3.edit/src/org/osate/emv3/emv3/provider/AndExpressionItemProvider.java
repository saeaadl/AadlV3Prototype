...
/**
 * This is the item provider adapter for a {@link org.osate.emv3.emv3.AndExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AndExpressionItemProvider extends ConditionExpressionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Emv3Package.Literals.AND_EXPRESSION__OPERANDS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AndExpression.class)) {
			case Emv3Package.AND_EXPRESSION__OPERANDS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Emv3Package.Literals.AND_EXPRESSION__OPERANDS,
