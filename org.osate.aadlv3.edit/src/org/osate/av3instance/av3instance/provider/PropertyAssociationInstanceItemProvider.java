 ...
 * @generated
 */
public class PropertyAssociationInstanceItemProvider extends InstanceObjectItemProvider {
	/**
	...
	protected void addPropertyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyAssociationInstance_property_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_PropertyAssociationInstance_property_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_PropertyAssociationInstance_type"), //$NON-NLS-1$
				Av3instancePackage.Literals.PROPERTY_ASSOCIATION_INSTANCE__PROPERTY, true, false, true, null, null,
				null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			//			childrenFeatures.add(Av3instancePackage.Literals.PROPERTY_ASSOCIATION_INSTANCE__VALUE);
		}
	...
	public String getText(Object object) {
		...
		Literal pvalue = ((PropertyAssociationInstance) object).getValue();
		String value = pvalue instanceof IntegerLiteral && pvalue != null ? ((IntegerLiteral)pvalue).getValue() + " " + (((IntegerLiteral)pvalue).getUnit()!= null ? ((IntegerLiteral)pvalue).getUnit():"") : "0";
