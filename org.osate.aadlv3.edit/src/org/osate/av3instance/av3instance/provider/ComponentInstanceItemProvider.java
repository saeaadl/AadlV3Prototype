 ...
 * @generated
 */
public class ComponentInstanceItemProvider extends InstanceObjectItemProvider {
	/**
	...
	protected void addCategoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Av3instancePackage.Literals.COMPONENT_INSTANCE__CATEGORY, true, false, false,
	...
	protected void addComponentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_ComponentInstance_component_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_ComponentInstance_component_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_ComponentInstance_type"), //$NON-NLS-1$
				Av3instancePackage.Literals.COMPONENT_INSTANCE__COMPONENT, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Av3instancePackage.Literals.COMPONENT_INSTANCE__SINKS);
		}
