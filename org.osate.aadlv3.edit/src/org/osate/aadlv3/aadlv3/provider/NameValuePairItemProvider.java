...
/**
 * This is the item provider adapter for a {@link org.osate.aadlv3.aadlv3.NameValuePair} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NameValuePairItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public NameValuePairItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_NameValuePair_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_NameValuePair_name_feature",
								"_UI_NameValuePair_type"),
						Aadlv3Package.Literals.NAME_VALUE_PAIR__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadlv3Package.Literals.NAME_VALUE_PAIR__VALUE);
		}
	...
	/**
	 * This returns NameValuePair.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NameValuePair"));
	}
	...
	public String getText(Object object) {
		String label = ((NameValuePair) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_NameValuePair_type")
				: getString("_UI_NameValuePair_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NameValuePair.class)) {
		case Aadlv3Package.NAME_VALUE_PAIR__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case Aadlv3Package.NAME_VALUE_PAIR__VALUE:
