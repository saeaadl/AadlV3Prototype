...
/**
 * This is the item provider adapter for a {@link org.osate.aadlv3.aadlv3.ComponentInterface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentInterfaceItemProvider extends ComponentClassifierItemProvider {
	...
	protected void addUsePropertiesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ComponentInterface_useProperties_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_ComponentInterface_useProperties_feature",
						"_UI_ComponentInterface_type"),
				Aadlv3Package.Literals.COMPONENT_INTERFACE__USE_PROPERTIES, true, false, true, null, null, null));
	}
