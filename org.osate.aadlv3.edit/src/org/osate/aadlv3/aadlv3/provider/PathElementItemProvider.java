...
/**
 * This is the item provider adapter for a {@link org.osate.aadlv3.aadlv3.PathElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PathElementItemProvider extends NamedElementReferenceItemProvider {
	...
	protected void addPreviousPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_PathElement_previous_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_PathElement_previous_feature",
								"_UI_PathElement_type"),
						Aadlv3Package.Literals.PATH_ELEMENT__PREVIOUS, true, false, true, null, null, null));
	}
	...
	protected void addNextPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_PathElement_next_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_PathElement_next_feature",
								"_UI_PathElement_type"),
						Aadlv3Package.Literals.PATH_ELEMENT__NEXT, true, false, true, null, null, null));
	}
