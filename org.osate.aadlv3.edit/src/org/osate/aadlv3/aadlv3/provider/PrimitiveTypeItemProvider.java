...
public class PrimitiveTypeItemProvider extends TypeItemProvider {
	...
	protected void addPrimitiveTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_PrimitiveType_primitiveType_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_PrimitiveType_primitiveType_feature",
								"_UI_PrimitiveType_type"),
						Aadlv3Package.Literals.PRIMITIVE_TYPE__PRIMITIVE_TYPE, true, false, false,
	...
	public String getText(Object object) {
		Primitive labelValue = ((PrimitiveType) object).getPrimitiveType();
	...
	public void notifyChanged(Notification notification) {
		...
		case Aadlv3Package.PRIMITIVE_TYPE__PRIMITIVE_TYPE:
