...
/**
 * This is the item provider adapter for a {@link org.osate.aadlv3.aadlv3.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider extends ModelElementItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_source_feature",
								"_UI_Transition_type"),
						Aadlv3Package.Literals.TRANSITION__SOURCE, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_target_feature",
								"_UI_Transition_type"),
						Aadlv3Package.Literals.TRANSITION__TARGET, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadlv3Package.Literals.TRANSITION__TRIGGERS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case Aadlv3Package.TRANSITION__TRIGGERS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Aadlv3Package.Literals.TRANSITION__TRIGGERS,
