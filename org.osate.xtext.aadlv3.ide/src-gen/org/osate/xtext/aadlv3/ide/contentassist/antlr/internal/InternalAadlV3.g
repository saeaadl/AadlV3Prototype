...
entryRuleIsFlowPath
:
{ before(grammarAccess.getIsFlowPathRule()); }
	 ruleIsFlowPath
{ after(grammarAccess.getIsFlowPathRule()); } 
	 EOF 
;
...
ruleIsFlowPath 
	...
	:
	(
		{ before(grammarAccess.getIsFlowPathAccess().getFlowPathKeywordsParserRuleCall()); }
		ruleFlowPathKeywords
		{ after(grammarAccess.getIsFlowPathAccess().getFlowPathKeywordsParserRuleCall()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getPackageDeclarationAccess().getImportsAssignment_4_0()); }
		(rule__PackageDeclaration__ImportsAssignment_4_0)
		{ after(grammarAccess.getPackageDeclarationAccess().getImportsAssignment_4_0()); }
	)
	|
	(
		{ before(grammarAccess.getPackageDeclarationAccess().getElementsAssignment_4_1()); }
		(rule__PackageDeclaration__ElementsAssignment_4_1)
		{ after(grammarAccess.getPackageDeclarationAccess().getElementsAssignment_4_1()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
(
	{ before(grammarAccess.getFeatureAccess().getAnnexSubclauseAssignment_6()); }
	(rule__Feature__AnnexSubclauseAssignment_6)?
	{ after(grammarAccess.getFeatureAccess().getAnnexSubclauseAssignment_6()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
(
	{ before(grammarAccess.getConfigurationAssignmentAccess().getSemicolonKeyword_3()); }
	';'
	{ after(grammarAccess.getConfigurationAssignmentAccess().getSemicolonKeyword_3()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
(
	{ before(grammarAccess.getConfigurationAssignmentPatternAccess().getQueryExpressionParserRuleCall_0()); }
	ruleQueryExpression
	{ after(grammarAccess.getConfigurationAssignmentPatternAccess().getQueryExpressionParserRuleCall_0()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
(
	{ before(grammarAccess.getConfigurationAssignmentPatternAccess().getEqualsSignGreaterThanSignKeyword_1()); }
	'=>'
	{ after(grammarAccess.getConfigurationAssignmentPatternAccess().getEqualsSignGreaterThanSignKeyword_1()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	...
	rule__ConfigurationAssignmentPattern__Group__3
;
finally {
	restoreStackSize(stackSize);
}
...
:
	rule__ConfigurationAssignmentPattern__Group__3__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
	{ before(grammarAccess.getConfigurationAssignmentPatternAccess().getSemicolonKeyword_3()); }
	';'
	{ after(grammarAccess.getConfigurationAssignmentPatternAccess().getSemicolonKeyword_3()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
(
	{ before(grammarAccess.getAnnexSubclauseAccess().getLeftCurlyBracketAsteriskKeyword_2()); }
	'{*'
	{ after(grammarAccess.getAnnexSubclauseAccess().getLeftCurlyBracketAsteriskKeyword_2()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
(
	{ before(grammarAccess.getAnnexSubclauseAccess().getAsteriskRightCurlyBracketKeyword_3()); }
	'*}'
	{ after(grammarAccess.getAnnexSubclauseAccess().getAsteriskRightCurlyBracketKeyword_3()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getPackageDeclarationAccess().getImportsImportParserRuleCall_4_0_0()); }
		ruleImport
		{ after(grammarAccess.getPackageDeclarationAccess().getImportsImportParserRuleCall_4_0_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getPackageDeclarationAccess().getElementsPackageElementParserRuleCall_4_1_0()); }
		rulePackageElement
		{ after(grammarAccess.getPackageDeclarationAccess().getElementsPackageElementParserRuleCall_4_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getFeatureAccess().getAnnexSubclauseAnnexSubclauseParserRuleCall_6_0()); }
		ruleAnnexSubclause
		{ after(grammarAccess.getFeatureAccess().getAnnexSubclauseAnnexSubclauseParserRuleCall_6_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getBindingAccess().getBindingTypeDataTypeCrossReference_2_0()); }
		(
			{ before(grammarAccess.getBindingAccess().getBindingTypeDataTypeQualifiedNameParserRuleCall_2_0_1()); }
			ruleQualifiedName
			{ after(grammarAccess.getBindingAccess().getBindingTypeDataTypeQualifiedNameParserRuleCall_2_0_1()); }
		)
		{ after(grammarAccess.getBindingAccess().getBindingTypeDataTypeCrossReference_2_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getFlowPathAccess().getAssociationTypeIsFlowPathParserRuleCall_2_0()); }
		ruleIsFlowPath
		{ after(grammarAccess.getFlowPathAccess().getAssociationTypeIsFlowPathParserRuleCall_2_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
