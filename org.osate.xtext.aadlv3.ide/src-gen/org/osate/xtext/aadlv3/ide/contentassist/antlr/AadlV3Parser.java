...
public class AadlV3Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AadlV3GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getComponentInterfaceAccess().getAlternatives_5(), "rule__ComponentInterface__Alternatives_5");
			builder.put(grammarAccess.getSectionsInterfaceBodyAccess().getAlternatives_1_1(), "rule__SectionsInterfaceBody__Alternatives_1_1");
			builder.put(grammarAccess.getInterfaceBodyAccess().getAlternatives_1(), "rule__InterfaceBody__Alternatives_1");
			builder.put(grammarAccess.getComponentImplementationAccess().getAlternatives_5(), "rule__ComponentImplementation__Alternatives_5");
			builder.put(grammarAccess.getSectionsImplementationBodyAccess().getAlternatives_0_1(), "rule__SectionsImplementationBody__Alternatives_0_1");
			builder.put(grammarAccess.getSectionsImplementationBodyAccess().getConnectionsAlternatives_1_1_0(), "rule__SectionsImplementationBody__ConnectionsAlternatives_1_1_0");
			builder.put(grammarAccess.getSectionsImplementationBodyAccess().getAlternatives_2_1(), "rule__SectionsImplementationBody__Alternatives_2_1");
			builder.put(grammarAccess.getImplementationBodyAccess().getAlternatives_1(), "rule__ImplementationBody__Alternatives_1");
			...
			builder.put(grammarAccess.getConfigurationElementBlockAccess().getAlternatives_1(), "rule__ConfigurationElementBlock__Alternatives_1");
			builder.put(grammarAccess.getCurlyConfigurationElementBlockAccess().getAlternatives_1(), "rule__CurlyConfigurationElementBlock__Alternatives_1");
			builder.put(grammarAccess.getTypeReferenceAccess().getAlternatives_0(), "rule__TypeReference__Alternatives_0");
			builder.put(grammarAccess.getNestedComponentImplementationBlockAccess().getAlternatives_1(), "rule__NestedComponentImplementationBlock__Alternatives_1");
			...
			builder.put(grammarAccess.getComponentInterfaceAccess().getGroup_3(), "rule__ComponentInterface__Group_3__0");
			builder.put(grammarAccess.getComponentInterfaceAccess().getGroup_4(), "rule__ComponentInterface__Group_4__0");
			builder.put(grammarAccess.getComponentInterfaceAccess().getGroup_4_3(), "rule__ComponentInterface__Group_4_3__0");
			builder.put(grammarAccess.getSectionsInterfaceBodyAccess().getGroup(), "rule__SectionsInterfaceBody__Group__0");
			builder.put(grammarAccess.getSectionsInterfaceBodyAccess().getGroup_0(), "rule__SectionsInterfaceBody__Group_0__0");
			builder.put(grammarAccess.getSectionsInterfaceBodyAccess().getGroup_1(), "rule__SectionsInterfaceBody__Group_1__0");
			builder.put(grammarAccess.getSectionsInterfaceBodyAccess().getGroup_2(), "rule__SectionsInterfaceBody__Group_2__0");
			...
			builder.put(grammarAccess.getSectionsImplementationBodyAccess().getGroup(), "rule__SectionsImplementationBody__Group__0");
			builder.put(grammarAccess.getSectionsImplementationBodyAccess().getGroup_0(), "rule__SectionsImplementationBody__Group_0__0");
			builder.put(grammarAccess.getSectionsImplementationBodyAccess().getGroup_1(), "rule__SectionsImplementationBody__Group_1__0");
			builder.put(grammarAccess.getSectionsImplementationBodyAccess().getGroup_2(), "rule__SectionsImplementationBody__Group_2__0");
			builder.put(grammarAccess.getSectionsImplementationBodyAccess().getGroup_3(), "rule__SectionsImplementationBody__Group_3__0");
			...
			builder.put(grammarAccess.getTypeReferenceAccess().getGroup_0_0(), "rule__TypeReference__Group_0_0__0");
			...
			builder.put(grammarAccess.getClassifierExtensionsAccess().getGroup(), "rule__ClassifierExtensions__Group__0");
			builder.put(grammarAccess.getClassifierExtensionsAccess().getGroup_1(), "rule__ClassifierExtensions__Group_1__0");
			...
			builder.put(grammarAccess.getPropertySetAccess().getNameAssignment_0(), "rule__PropertySet__NameAssignment_0");
			...
			builder.put(grammarAccess.getComponentInterfaceAccess().getCategoryAssignment_0(), "rule__ComponentInterface__CategoryAssignment_0");
			builder.put(grammarAccess.getComponentInterfaceAccess().getNameAssignment_2(), "rule__ComponentInterface__NameAssignment_2");
			builder.put(grammarAccess.getComponentInterfaceAccess().getUsePropertiesAssignment_4_2(), "rule__ComponentInterface__UsePropertiesAssignment_4_2");
			builder.put(grammarAccess.getComponentInterfaceAccess().getUsePropertiesAssignment_4_3_1(), "rule__ComponentInterface__UsePropertiesAssignment_4_3_1");
			builder.put(grammarAccess.getSectionsInterfaceBodyAccess().getFeaturesAssignment_0_1(), "rule__SectionsInterfaceBody__FeaturesAssignment_0_1");
			builder.put(grammarAccess.getSectionsInterfaceBodyAccess().getFlowsAssignment_1_1_0(), "rule__SectionsInterfaceBody__FlowsAssignment_1_1_0");
			builder.put(grammarAccess.getSectionsInterfaceBodyAccess().getFlowsAssignment_1_1_1(), "rule__SectionsInterfaceBody__FlowsAssignment_1_1_1");
			builder.put(grammarAccess.getSectionsInterfaceBodyAccess().getFlowsAssignment_1_1_2(), "rule__SectionsInterfaceBody__FlowsAssignment_1_1_2");
			builder.put(grammarAccess.getInterfaceBodyAccess().getFeaturesAssignment_1_0(), "rule__InterfaceBody__FeaturesAssignment_1_0");
			builder.put(grammarAccess.getInterfaceBodyAccess().getFlowsAssignment_1_1(), "rule__InterfaceBody__FlowsAssignment_1_1");
			builder.put(grammarAccess.getInterfaceBodyAccess().getFlowsAssignment_1_2(), "rule__InterfaceBody__FlowsAssignment_1_2");
			builder.put(grammarAccess.getInterfaceBodyAccess().getFlowsAssignment_1_3(), "rule__InterfaceBody__FlowsAssignment_1_3");
			builder.put(grammarAccess.getComponentImplementationAccess().getCategoryAssignment_0(), "rule__ComponentImplementation__CategoryAssignment_0");
			builder.put(grammarAccess.getComponentImplementationAccess().getInterfaceAssignment_1(), "rule__ComponentImplementation__InterfaceAssignment_1");
			...
			builder.put(grammarAccess.getSectionsImplementationBodyAccess().getComponentsAssignment_0_1_0(), "rule__SectionsImplementationBody__ComponentsAssignment_0_1_0");
			builder.put(grammarAccess.getSectionsImplementationBodyAccess().getAssignmentsAssignment_0_1_1(), "rule__SectionsImplementationBody__AssignmentsAssignment_0_1_1");
			builder.put(grammarAccess.getSectionsImplementationBodyAccess().getConnectionsAssignment_1_1(), "rule__SectionsImplementationBody__ConnectionsAssignment_1_1");
			builder.put(grammarAccess.getSectionsImplementationBodyAccess().getFlowAssignmentsAssignment_2_1_0(), "rule__SectionsImplementationBody__FlowAssignmentsAssignment_2_1_0");
			builder.put(grammarAccess.getSectionsImplementationBodyAccess().getPathsAssignment_2_1_1(), "rule__SectionsImplementationBody__PathsAssignment_2_1_1");
			builder.put(grammarAccess.getImplementationBodyAccess().getConnectionsAssignment_1_0(), "rule__ImplementationBody__ConnectionsAssignment_1_0");
			builder.put(grammarAccess.getImplementationBodyAccess().getConnectionsAssignment_1_1(), "rule__ImplementationBody__ConnectionsAssignment_1_1");
			builder.put(grammarAccess.getImplementationBodyAccess().getComponentsAssignment_1_2(), "rule__ImplementationBody__ComponentsAssignment_1_2");
			builder.put(grammarAccess.getImplementationBodyAccess().getPathsAssignment_1_3(), "rule__ImplementationBody__PathsAssignment_1_3");
			builder.put(grammarAccess.getImplementationBodyAccess().getFlowAssignmentsAssignment_1_4(), "rule__ImplementationBody__FlowAssignmentsAssignment_1_4");
			builder.put(grammarAccess.getImplementationBodyAccess().getAssignmentsAssignment_1_5(), "rule__ImplementationBody__AssignmentsAssignment_1_5");
			builder.put(grammarAccess.getComponentConfigurationAccess().getInterfaceAssignment_1(), "rule__ComponentConfiguration__InterfaceAssignment_1");
			...
			builder.put(grammarAccess.getFeatureAccess().getReverseAssignment_5(), "rule__Feature__ReverseAssignment_5");
			builder.put(grammarAccess.getFeatureAccess().getTypeAssignment_6(), "rule__Feature__TypeAssignment_6");
			...
			builder.put(grammarAccess.getConfigurationElementBlockAccess().getPropertyAssociationsAssignment_1_0(), "rule__ConfigurationElementBlock__PropertyAssociationsAssignment_1_0");
			builder.put(grammarAccess.getConfigurationElementBlockAccess().getAssignmentsAssignment_1_1(), "rule__ConfigurationElementBlock__AssignmentsAssignment_1_1");
			builder.put(grammarAccess.getPropertyElementAccess().getPropertyAssociationsAssignment(), "rule__PropertyElement__PropertyAssociationsAssignment");
			builder.put(grammarAccess.getConfigurationElementAccess().getAssignmentsAssignment(), "rule__ConfigurationElement__AssignmentsAssignment");
			...
			builder.put(grammarAccess.getTypeReferenceAccess().getComponentinterfaceAssignment_0_0_0(), "rule__TypeReference__ComponentinterfaceAssignment_0_0_0");
			builder.put(grammarAccess.getTypeReferenceAccess().getTypeAssignment_0_0_2(), "rule__TypeReference__TypeAssignment_0_0_2");
			builder.put(grammarAccess.getTypeReferenceAccess().getTypeAssignment_0_1(), "rule__TypeReference__TypeAssignment_0_1");
			builder.put(grammarAccess.getNestedComponentImplementationBlockAccess().getFeaturesAssignment_1_0(), "rule__NestedComponentImplementationBlock__FeaturesAssignment_1_0");
			builder.put(grammarAccess.getNestedComponentImplementationBlockAccess().getConnectionsAssignment_1_1(), "rule__NestedComponentImplementationBlock__ConnectionsAssignment_1_1");
			builder.put(grammarAccess.getNestedComponentImplementationBlockAccess().getConnectionsAssignment_1_2(), "rule__NestedComponentImplementationBlock__ConnectionsAssignment_1_2");
			builder.put(grammarAccess.getNestedComponentImplementationBlockAccess().getComponentsAssignment_1_3(), "rule__NestedComponentImplementationBlock__ComponentsAssignment_1_3");
			builder.put(grammarAccess.getClassifierExtensionsAccess().getSuperClassifiersAssignment_0(), "rule__ClassifierExtensions__SuperClassifiersAssignment_0");
			builder.put(grammarAccess.getClassifierExtensionsAccess().getSuperClassifiersAssignment_1_1(), "rule__ClassifierExtensions__SuperClassifiersAssignment_1_1");
