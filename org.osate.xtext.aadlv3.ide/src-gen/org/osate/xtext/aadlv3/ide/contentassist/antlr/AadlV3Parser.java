...
public class AadlV3Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AadlV3GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getInterfaceElementAccess().getStateVariablesAssignment_4(), "rule__InterfaceElement__StateVariablesAssignment_4");
			builder.put(grammarAccess.getInterfaceElementAccess().getBehaviorRulesAssignment_5(), "rule__InterfaceElement__BehaviorRulesAssignment_5");
			builder.put(grammarAccess.getInterfaceElementAccess().getBehaviorRulesAssignment_6(), "rule__InterfaceElement__BehaviorRulesAssignment_6");
			builder.put(grammarAccess.getInterfaceElementAccess().getGeneratorsAssignment_7(), "rule__InterfaceElement__GeneratorsAssignment_7");
			builder.put(grammarAccess.getInterfaceElementAccess().getOwnedPropertyAssociationsAssignment_8(), "rule__InterfaceElement__OwnedPropertyAssociationsAssignment_8");
			builder.put(grammarAccess.getInterfaceElementAccess().getAnnexSubclauseAssignment_9(), "rule__InterfaceElement__AnnexSubclauseAssignment_9");
			...
			builder.put(grammarAccess.getModelElementContainsLiteralAccess().getElementAssignment_0(), "rule__ModelElementContainsLiteral__ElementAssignment_0");
			...
			builder.put(grammarAccess.getModelElementContainsLiteralAccess().getConstraintAssignment_2(), "rule__ModelElementContainsLiteral__ConstraintAssignment_2");
