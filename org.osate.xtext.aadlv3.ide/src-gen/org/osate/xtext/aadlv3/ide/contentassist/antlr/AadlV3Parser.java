...
public class AadlV3Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AadlV3GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getGeneratorAccess().getTypeAlternatives_3_0(), "rule__Generator__TypeAlternatives_3_0");
			...
			builder.put(grammarAccess.getFlowRuleAccess().getAlternatives(), "rule__FlowRule__Alternatives");
			builder.put(grammarAccess.getFlowPathRuleAccess().getConditionAlternatives_4_0(), "rule__FlowPathRule__ConditionAlternatives_4_0");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getConditionAlternatives_5_0(), "rule__FlowSourceRule__ConditionAlternatives_5_0");
			builder.put(grammarAccess.getFlowSinkRuleAccess().getConditionAlternatives_4_0(), "rule__FlowSinkRule__ConditionAlternatives_4_0");
			builder.put(grammarAccess.getAnnotationAccess().getAlternatives_2_1(), "rule__Annotation__Alternatives_2_1");
			...
			builder.put(grammarAccess.getInModesAccess().getGroup(), "rule__InModes__Group__0");
			...
			builder.put(grammarAccess.getFlowPathRuleAccess().getGroup(), "rule__FlowPathRule__Group__0");
			builder.put(grammarAccess.getFlowPathRuleAccess().getGroup_7(), "rule__FlowPathRule__Group_7__0");
			builder.put(grammarAccess.getFlowPathRuleAccess().getGroup_8(), "rule__FlowPathRule__Group_8__0");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getGroup(), "rule__FlowSourceRule__Group__0");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getGroup_6(), "rule__FlowSourceRule__Group_6__0");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getGroup_6_1(), "rule__FlowSourceRule__Group_6_1__0");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getGroup_6_1_1(), "rule__FlowSourceRule__Group_6_1_1__0");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getGroup_7(), "rule__FlowSourceRule__Group_7__0");
			builder.put(grammarAccess.getFlowSinkRuleAccess().getGroup(), "rule__FlowSinkRule__Group__0");
			builder.put(grammarAccess.getFlowSinkRuleAccess().getGroup_7(), "rule__FlowSinkRule__Group_7__0");
			builder.put(grammarAccess.getAssignmentAccess().getGroup(), "rule__Assignment__Group__0");
			builder.put(grammarAccess.getAssignmentAccess().getGroup_1(), "rule__Assignment__Group_1__0");
			builder.put(grammarAccess.getCurrentStateAccess().getGroup(), "rule__CurrentState__Group__0");
			...
			builder.put(grammarAccess.getConstantDefAccess().getAnnotationsAssignment_0(), "rule__ConstantDef__AnnotationsAssignment_0");
			builder.put(grammarAccess.getConstantDefAccess().getPrivateAssignment_1(), "rule__ConstantDef__PrivateAssignment_1");
			builder.put(grammarAccess.getConstantDefAccess().getNameAssignment_3(), "rule__ConstantDef__NameAssignment_3");
			builder.put(grammarAccess.getConstantDefAccess().getValueAssignment_5(), "rule__ConstantDef__ValueAssignment_5");
			...
			builder.put(grammarAccess.getInterfaceElementAccess().getBehaviorRulesAssignment_2(), "rule__InterfaceElement__BehaviorRulesAssignment_2");
			builder.put(grammarAccess.getInterfaceElementAccess().getBehaviorRulesAssignment_3(), "rule__InterfaceElement__BehaviorRulesAssignment_3");
			...
			builder.put(grammarAccess.getImplementationElementAccess().getBehaviorRulesAssignment_8(), "rule__ImplementationElement__BehaviorRulesAssignment_8");
			builder.put(grammarAccess.getImplementationElementAccess().getBehaviorRulesAssignment_9(), "rule__ImplementationElement__BehaviorRulesAssignment_9");
			...
			builder.put(grammarAccess.getSubcomponentAccess().getTypeReferencesAssignment_5(), "rule__Subcomponent__TypeReferencesAssignment_5");
			...
			builder.put(grammarAccess.getInModesAccess().getInModesAssignment_1(), "rule__InModes__InModesAssignment_1");
			...
			builder.put(grammarAccess.getBehaviorSpecificationElementAccess().getRulesAssignment_2(), "rule__BehaviorSpecificationElement__RulesAssignment_2");
			...
			builder.put(grammarAccess.getStateVariableAccess().getInitialStateAssignment_5(), "rule__StateVariable__InitialStateAssignment_5");
			...
			builder.put(grammarAccess.getFlowPathRuleAccess().getAnnotationsAssignment_0(), "rule__FlowPathRule__AnnotationsAssignment_0");
			builder.put(grammarAccess.getFlowPathRuleAccess().getNameAssignment_1(), "rule__FlowPathRule__NameAssignment_1");
			builder.put(grammarAccess.getFlowPathRuleAccess().getConditionAssignment_4(), "rule__FlowPathRule__ConditionAssignment_4");
			builder.put(grammarAccess.getFlowPathRuleAccess().getActionsAssignment_6(), "rule__FlowPathRule__ActionsAssignment_6");
			builder.put(grammarAccess.getFlowPathRuleAccess().getActionsAssignment_7_1(), "rule__FlowPathRule__ActionsAssignment_7_1");
			builder.put(grammarAccess.getFlowPathRuleAccess().getCurrentStateAssignment_8_1(), "rule__FlowPathRule__CurrentStateAssignment_8_1");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getAnnotationsAssignment_0(), "rule__FlowSourceRule__AnnotationsAssignment_0");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getNameAssignment_1(), "rule__FlowSourceRule__NameAssignment_1");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getSourceAssignment_4(), "rule__FlowSourceRule__SourceAssignment_4");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getConditionAssignment_5(), "rule__FlowSourceRule__ConditionAssignment_5");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getActionsAssignment_6_1_0(), "rule__FlowSourceRule__ActionsAssignment_6_1_0");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getActionsAssignment_6_1_1_1(), "rule__FlowSourceRule__ActionsAssignment_6_1_1_1");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getCurrentStateAssignment_7_1(), "rule__FlowSourceRule__CurrentStateAssignment_7_1");
			builder.put(grammarAccess.getFlowSinkRuleAccess().getAnnotationsAssignment_0(), "rule__FlowSinkRule__AnnotationsAssignment_0");
			builder.put(grammarAccess.getFlowSinkRuleAccess().getNameAssignment_1(), "rule__FlowSinkRule__NameAssignment_1");
			builder.put(grammarAccess.getFlowSinkRuleAccess().getConditionAssignment_4(), "rule__FlowSinkRule__ConditionAssignment_4");
			builder.put(grammarAccess.getFlowSinkRuleAccess().getSinkAssignment_6(), "rule__FlowSinkRule__SinkAssignment_6");
			builder.put(grammarAccess.getFlowSinkRuleAccess().getCurrentStateAssignment_7_1(), "rule__FlowSinkRule__CurrentStateAssignment_7_1");
			builder.put(grammarAccess.getAssignmentAccess().getLeftAssignment_0(), "rule__Assignment__LeftAssignment_0");
			builder.put(grammarAccess.getAssignmentAccess().getOperatorAssignment_1_0(), "rule__Assignment__OperatorAssignment_1_0");
			builder.put(grammarAccess.getAssignmentAccess().getRightAssignment_1_1(), "rule__Assignment__RightAssignment_1_1");
			builder.put(grammarAccess.getCurrentStateAccess().getStateVariableAssignment_0(), "rule__CurrentState__StateVariableAssignment_0");
			builder.put(grammarAccess.getCurrentStateAccess().getCurrentStateAssignment_2(), "rule__CurrentState__CurrentStateAssignment_2");
			builder.put(grammarAccess.getTargetStateAccess().getStateVariableAssignment_0(), "rule__TargetState__StateVariableAssignment_0");
			builder.put(grammarAccess.getTargetStateAccess().getCurrentStateAssignment_2(), "rule__TargetState__CurrentStateAssignment_2");
			...
			builder.put(grammarAccess.getAnnotationAccess().getValueAssignment_2_1_0(), "rule__Annotation__ValueAssignment_2_1_0");
			builder.put(grammarAccess.getAnnotationAccess().getNameValuePairsAssignment_2_1_1(), "rule__Annotation__NameValuePairsAssignment_2_1_1");
