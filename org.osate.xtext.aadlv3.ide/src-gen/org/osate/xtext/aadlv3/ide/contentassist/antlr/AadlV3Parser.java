...
public class AadlV3Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AadlV3GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getInstanceConfigurationAccess().getProductlineConstraintAssignment_5(), "rule__InstanceConfiguration__ProductlineConstraintAssignment_5");
			builder.put(grammarAccess.getProductLineConstraintAccess().getElementAssignment_1(), "rule__ProductLineConstraint__ElementAssignment_1");
			builder.put(grammarAccess.getProductLineConstraintAccess().getOperatorAssignment_2(), "rule__ProductLineConstraint__OperatorAssignment_2");
			builder.put(grammarAccess.getProductLineConstraintAccess().getConstraintAssignment_3(), "rule__ProductLineConstraint__ConstraintAssignment_3");
			...
			builder.put(grammarAccess.getBehaviorSpecificationBlockAccess().getStatesAssignment_0_2(), "rule__BehaviorSpecificationBlock__StatesAssignment_0_2");
