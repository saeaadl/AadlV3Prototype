...
public class AadlV3Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AadlV3GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPropertyDefinitionAccess().getGroup_4_2(), "rule__PropertyDefinition__Group_4_2__0");
			...
			builder.put(grammarAccess.getComponentAccess().getGroup_3_1(), "rule__Component__Group_3_1__0");
			...
			builder.put(grammarAccess.getPropertiesBlockAccess().getGroup_2(), "rule__PropertiesBlock__Group_2__0");
			...
			builder.put(grammarAccess.getPropertyDefinitionAccess().getTypeAssignment_3(), "rule__PropertyDefinition__TypeAssignment_3");
			...
			builder.put(grammarAccess.getImplementationElementAccess().getConfigurationAssignmentsAssignment_5(), "rule__ImplementationElement__ConfigurationAssignmentsAssignment_5");
			...
			builder.put(grammarAccess.getImplementationElementAccess().getPropertyAssociationsAssignment_7(), "rule__ImplementationElement__PropertyAssociationsAssignment_7");
			...
			builder.put(grammarAccess.getComponentAccess().getTypeReferencesAssignment_3_0(), "rule__Component__TypeReferencesAssignment_3_0");
			builder.put(grammarAccess.getComponentAccess().getTypeReferencesAssignment_3_1_1(), "rule__Component__TypeReferencesAssignment_3_1_1");
			...
			builder.put(grammarAccess.getPropertyAssociationAccess().getValueAssignment_5(), "rule__PropertyAssociation__ValueAssignment_5");
			...
			builder.put(grammarAccess.getConfigurationElementAccess().getConfigurationAssignmentsAssignment_1(), "rule__ConfigurationElement__ConfigurationAssignmentsAssignment_1");
			...
			builder.put(grammarAccess.getPropertiesBlockAccess().getPropertyAssociationsAssignment_2_1(), "rule__PropertiesBlock__PropertyAssociationsAssignment_2_1");
			...
			builder.put(grammarAccess.getWorkingsetAccess().getRootComponentsAssignment_4(), "rule__Workingset__RootComponentsAssignment_4");
			builder.put(grammarAccess.getWorkingsetAccess().getRootComponentsAssignment_5_1(), "rule__Workingset__RootComponentsAssignment_5_1");
		}
	}
