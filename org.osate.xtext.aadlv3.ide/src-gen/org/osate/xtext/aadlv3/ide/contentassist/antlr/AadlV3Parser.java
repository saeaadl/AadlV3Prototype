...
public class AadlV3Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AadlV3GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getProductLineConstraintAccess().getLeftAssignment_1(), "rule__ProductLineConstraint__LeftAssignment_1");
			...
			builder.put(grammarAccess.getProductLineConstraintAccess().getRightAssignment_3(), "rule__ProductLineConstraint__RightAssignment_3");
