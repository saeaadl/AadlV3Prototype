...
public class AadlV3Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AadlV3GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFlowPathAccess().getAnnotationsAssignment_0(), "rule__FlowPath__AnnotationsAssignment_0");
			...
			builder.put(grammarAccess.getFlowSourceAccess().getAnnotationsAssignment_0(), "rule__FlowSource__AnnotationsAssignment_0");
			...
			builder.put(grammarAccess.getTypedTokenAccess().getAnnotationsAssignment_0(), "rule__TypedToken__AnnotationsAssignment_0");
