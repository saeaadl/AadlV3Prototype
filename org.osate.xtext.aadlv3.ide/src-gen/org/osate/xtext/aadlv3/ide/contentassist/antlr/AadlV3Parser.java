...
public class AadlV3Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AadlV3GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getBehaviorRuleAccess().getAlternatives(), "rule__BehaviorRule__Alternatives");
			...
			builder.put(grammarAccess.getFlowSourceRuleAccess().getConditionAlternatives_5_0_0(), "rule__FlowSourceRule__ConditionAlternatives_5_0_0");
			...
			builder.put(grammarAccess.getTransitionRuleAccess().getGroup_7(), "rule__TransitionRule__Group_7__0");
			...
			builder.put(grammarAccess.getFlowSourceRuleAccess().getGroup_5(), "rule__FlowSourceRule__Group_5__0");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getGroup_7(), "rule__FlowSourceRule__Group_7__0");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getGroup_8(), "rule__FlowSourceRule__Group_8__0");
			...
			builder.put(grammarAccess.getInterfaceElementAccess().getRulesAssignment_3(), "rule__InterfaceElement__RulesAssignment_3");
			...
			builder.put(grammarAccess.getImplementationElementAccess().getRulesAssignment_9(), "rule__ImplementationElement__RulesAssignment_9");
			...
			builder.put(grammarAccess.getSubcomponentAccess().getTypeReferencesAssignment_5_0(), "rule__Subcomponent__TypeReferencesAssignment_5_0");
			...
			builder.put(grammarAccess.getTransitionRuleAccess().getCurrentStateAssignment_7_1(), "rule__TransitionRule__CurrentStateAssignment_7_1");
			...
			builder.put(grammarAccess.getFlowSourceRuleAccess().getConditionAssignment_5_0(), "rule__FlowSourceRule__ConditionAssignment_5_0");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getActionsAssignment_6(), "rule__FlowSourceRule__ActionsAssignment_6");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getActionsAssignment_7_1(), "rule__FlowSourceRule__ActionsAssignment_7_1");
			builder.put(grammarAccess.getFlowSourceRuleAccess().getCurrentStateAssignment_8_1(), "rule__FlowSourceRule__CurrentStateAssignment_8_1");
