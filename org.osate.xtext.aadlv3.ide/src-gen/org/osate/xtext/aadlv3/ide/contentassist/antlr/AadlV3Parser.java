...
public class AadlV3Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AadlV3GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getComponentInterfaceAccess().getUsePropertiesAssignment_6_2(), "rule__ComponentInterface__UsePropertiesAssignment_6_2");
			builder.put(grammarAccess.getComponentInterfaceAccess().getUsePropertiesAssignment_6_3_1(), "rule__ComponentInterface__UsePropertiesAssignment_6_3_1");
